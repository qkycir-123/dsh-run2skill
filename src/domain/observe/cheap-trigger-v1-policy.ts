...
export const CHEAP_TRIGGER_V1_POLICY = Object.freeze({
  ...
  explicitSave: {
    ...
    requestContext: String.raw`^(?:(?:(?:(?:could|would) you please|please|can you|could you|would you)\s+)?\b(?:save|remember|capture)\b|i (?:want|need) you to \b(?:save|remember|capture)\b|(?:请|请把|把|将|帮我|麻烦).{0,24}(?:保存|记录|记住|沉淀|存成|\b(?:save|remember|capture)\b)|(?:保存|记录|记住|沉淀|存成))`,
